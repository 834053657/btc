...
export const getRouterData = (app) => {
    ...
    '/user-manage':
  {
    ...
    '/user-detail/:id':
  {
    component: dynamicWrapper(app, ['userDetail'], () => import('../routes/UserManage/Detail')),
  },
    '/trade-manage':
  {
    ...
    '/trade-detail/:id':
  {
    ...
    '/trade-im/:id':
  {
    component: dynamicWrapper(app, ['tradeDetail', 'tradeIm'], () => import('../routes/TradeManage/IM')),
  },
    '/transfer-manage':
  {
    ...
    '/sys-config':
  {
    component: dynamicWrapper(app, ['sysConfig'], () => import('../routes/SysConfig/SysForm')),
  },
    '/msg-detail/:id':
  {
