...
export const getRouterData = (app) => {
  const routerConfig = {
    ...
    '/ad-manage':
  {
    component: dynamicWrapper(app, ['ad'], () =>
    import('../routes/Ad/List')
    ),
  },
    '/user-manage':
  {
    ...
    '/trade-manage':
  {
    ...
    import('../routes/TradeManage/List')
    ),
  },
    '/transfer-manage':
  {
    component: dynamicWrapper(app, ['transfer_manage'], () =>
    import('../routes/TransferManage/List')
    ),
  },
    '/sys-config':
  {
